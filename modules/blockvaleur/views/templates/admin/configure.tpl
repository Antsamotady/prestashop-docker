...
<div class="bootstrap">
    <div class="page-head custom-tab">
        <div class="page-head-tabs" id="head_tabs">
            <ul class="nav">
                <li class="active">
                    <a href="#pscontent" data-toggle="tab">{l s='Content' d='Modules.Blockvaleur.Admin'}</a>
                </li>
                {* <li>
                    <a href="#display" data-toggle="tab">{l s='Display' d='Modules.Blockvaleur.Admin'}</a>
                </li>
                <li>
                    <a href="#appearance" data-toggle="tab">{l s='Appearance' d='Modules.Blockvaleur.Admin'}</a>
                </li> *}
            </ul>
        </div>
    </div>
...
<div class="bootstrap" id="blockvaleur_configuration">
    <!-- Module content -->
