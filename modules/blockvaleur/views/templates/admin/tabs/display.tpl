...
<div id="modulecontent module_display" class="clearfix">
    <div id="menu" class="col-lg-2 col-xs-2">
        <div class="list-group" v-on:click.prevent>
            <a href="#" class="list-group-item" v-bind:class="{ 'active': isActive('global') }"
                ...
                <i class="fa fa-cog"></i> {l s='Global settings' d='Modules.Blockvaleur.Admin'}
            </a>
            <a href="#" class="list-group-item" v-bind:class="{ 'active': isActive('product') }"
                v-on:click="makeActive('product')">
                <i class="fa fa-book"></i> {l s='Product pages' d='Modules.Blockvaleur.Admin'}
            </a>
            <a href="#" class="list-group-item" v-bind:class="{ 'active': isActive('checkout') }"
                v-on:click="makeActive('checkout')">
                <i class="fa fa-clock-o"></i> {l s='Checkout pages' d='Modules.Blockvaleur.Admin'}
            </a>
        </div>
    </div>
    <div class="col-lg-9 col-xs-9">
        ...
        <div id="global" class="blv_menu addons-hide">
            {include file="./display/global.tpl"}
        </div>

        <div id="product" class="blv_menu addons-hide">
            {include file="./display/product.tpl"}
        </div>

        <div id="checkout" class="blv_menu addons-hide">
