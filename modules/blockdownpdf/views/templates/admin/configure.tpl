...
<div class="bootstrap">
    <div class="page-head custom-tab">
        <div class="page-head-tabs" id="head_tabs">
            <ul class="nav">
                <li class="active">
                    <a href="#pscontent" data-toggle="tab">{l s='Content' d='Modules.Blockdownpdf.Admin'}</a>
                </li>
                {* <li>
                    <a href="#display" data-toggle="tab">{l s='Display' d='Modules.Blockdownpdf.Admin'}</a>
                </li>
                <li>
                    <a href="#appearance" data-toggle="tab">{l s='Appearance' d='Modules.Blockdownpdf.Admin'}</a>
                </li> *}
            </ul>
        </div>
    </div>
...
<div class="bootstrap" id="blockdownpdf_configuration">
    <!-- Module content -->
