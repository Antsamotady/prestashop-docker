    ...
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-3 first-block">
        <div class="text-right">
            <label class="control-label">
                {l s='Image' d='Modules.Blockdownpdf.Admin'}
            </label>
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-4 first-block">
        <div class="bld_picto_showing input-group col-lg-4">
        ...
        <div class="input-group upload_file_button">
            <label class="file_label" for="file{if isset($block)}{$block['id_blockdownpdf']}{/if}"
                data-label="{l s='or upload file' d='Modules.Blockdownpdf.Admin'}">{l s='or upload file' d='Modules.Blockdownpdf.Admin'}</label>
        ...
        <div class="help-block">
            {l s='Choose SVG for better customization. Other allowed formats are: .gif, .jpg, .png' d='Modules.Blockdownpdf.Admin'}
        </div>
    </div>
