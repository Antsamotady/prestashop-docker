...
<div id="reminder_listing"
    class="panel panel-default panel-blockdownpdf col-lg-10 col-lg-offset-1 col-xs-12 col-xs-offset-0">
    <div class="panel-heading">
        {l s='Block Content' d='Modules.Blockdownpdf.Admin'}
    ...
    <div class="panel-body first-body">
        <div class="clearfix">
            <div class="listing-table col-xs-12">
                ...
                <div id="list-blockdownpdf" class="listing-body col-lg-12 col-xs-12">
                    {foreach from=$allblock item=$block key=$key}
                        <div class="listing-general-rol row" data-block="{$block.id_blockdownpdf}">
                            <div class="blv-listing-row row">
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-8">
                                    ...
                                    {else}
                                        {l s='none' d='Modules.Blockdownpdf.Admin'}
                                    {/if}
                                </div>
                                <div class="hidden-lg hidden-md hidden-sm col-xs-4">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-8">
                                    ...
                                    {elseif $block['type_link'] == $LINK_TYPE_URL}
                                        {l s='Url link' d='Modules.Blockdownpdf.Admin'}
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-8 inline-flex">
                                    <label class="col-lg-12 col-xs-12 status-toggle"
                                        id="reminder_active_{$block['id_blockdownpdf']}"
                                        for="reminder_active_{$block['id_blockdownpdf']}"
                                        data-cart_blockdownpdf_id='{$block['id_blockdownpdf']}'>
                                        <section class="switch-input {if $block['status']}-checked{/if}">
                                            <input data-toggle="switch" class="switch-new" data-inverse="true"
                                                type="checkbox" name="reminder_active_{$block['id_blockdownpdf']}"
                                                checked="">
                                        </section>
                                        <span class="bld_switch_text switch-on"
                                            style="{if !$block['status']}display:none;{/if}">{l s='Activated' d='Modules.Blockdownpdf.Admin'}</span>
                                        <span class="bld_switch_text switch-off"
                                            style="{if $block['status']}display:none;{/if}">{l s='Deactivated' d='Modules.Blockdownpdf.Admin'}</span>
                                    </label>
                                    <div class="btn-group">
                                        <button class="btn btn-link dropdown-toggle" type="button" data-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false"></button>
                                        <div class="dropdown-menu" x-placement="bottom-start">
                                            <span class="dropdown-item psre-edit" data-id="{$block['id_blockdownpdf']}"><i
                                                    class="material-icons">mode_edit</i>
                                                {l s='Edit' d='Admin.Actions'}</span>
                                            <span class="dropdown-item psre-delete" data-id="{$block['id_blockdownpdf']}"><i
        ...
        <div class="msgRecommendation">
            {l s='We recommend 3 blocks at maximum.' d='Modules.Blockdownpdf.Admin'}
        </div>
    </div>
</div>
